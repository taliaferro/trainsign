...
class Open511Client:
    ...
    def _api_get(self, endpoint, params, raise_for_status=True):
        ...
        self.limit_remaining = int(response.headers.get("RateLimit-Remaining", self.limit_remaining))
    ...
    def stop_monitoring(self, agency, stop_code=None):
        ...
        return self._api_get("transit/StopMonitoring", params=params).json()
    ...
    def holidays(self, operator_id):
        params = {"operator_id": operator_id}
        return self._api_get("transit/holidays", params=params).json()
